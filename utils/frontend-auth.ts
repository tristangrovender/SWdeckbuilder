...
export function getSignInUrl() {
  ...
  const productionUrl =
    "https://swccgdb-production.auth.us-east-2.amazoncognito.com/login?client_id=3hganbcfgre49cutjo2acf2kv0&response_type=token&scope=email+openid+profile&redirect_uri=https://sw-deckbuilder.danielrasmuson.vercel.app/callback";
